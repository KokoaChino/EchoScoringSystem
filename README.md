...
1. 本项目不适用于手机端用户使用，请使用电脑端，浏览器缩放建议为 100%

2. 项目浏览卡顿为正常现象，因为我用的免费试用的云服务器，带宽是最低一档的

3. 项目只关心声骸的副词条属性，并且以此为依据作出评分

4. 项目不关心声骸的技能，主词条属性，套装效果等等
...
* 补全截止到鸣潮 1.4 版本的所有角色，但是还没有设置他们的权重
* 多个模块添加筛选角色功能
