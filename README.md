...
* **Nacos**：（需本地安装）
  ...
  并参考[Nacos 配置文件](Nacos 配置文件.md)创建对应的配置，放在 `public` 空间，组都是 `DEFAULT_GROUP`
...
│   │   │   │   │           │   └── GameDataRefreshEvent.java
│   │   │   │   │           ├── external
│   │   │   │   │           │   ├── config
│   │   │   │   │           │   │   └── HttpClientConfig.java
│   │   │   │   │           │   ├── dto
│   │   │   │   │           │   │   ├── CharacterDetailDTO.java
│   │   │   │   │           │   │   ├── CharacterExtraConfigDTO.java
│   │   │   │   │           │   │   └── WeaponDetailDTO.java
│   │   │   │   │           │   ├── service
│   │   │   │   │           │   │   ├── api
│   │   │   │   │           │   │   │   ├── CharacterExtraConfigService.java
│   │   │   │   │           │   │   │   ├── GameDataCacheService.java
│   │   │   │   │           │   │   │   ├── GameDataService.java
│   │   │   │   │           │   │   │   └── KujiequApiService.java
│   │   │   │   │           │   │   └── impl
│   │   │   │   │           │   │       ├── CharacterExtraConfigServiceImpl.java
│   │   │   │   │           │   │       ├── GameDataCacheServiceImpl.java
│   │   │   │   │           │   │       ├── GameDataServiceImpl.java
│   │   │   │   │           │   │       └── KujiequApiServiceImpl.java
│   │   │   │   │           │   └── util
│   │   │   │   │           │       ├── KujiequApiHttpUtil.java
│   │   │   │   │           │       └── KujiequApiParseUtil.java
│   │   │   │   │           ├── mapper
│   │   │   │   │           │   ├── persistence
│   │   │   │   │           │   │   ├── CharacterConfigDO.java
│   │   │   │   │           │   │   ├── CharacterExtraConfigDO.java
│   │   │   │   │           │   │   └── EchoDO.java
│   │   │   │   │           │   ├── CharacterExtraConfigMapper.java
│   │   │   │   │           │   └── EchoMapper.java
│   │   │   │   │           ├── service
│   │   │   │   │           │   ├── api
...
- 通过对接官方 API 动态获取角色与武器数据，结合本地缓存与数据库配置表，实现游戏数据自动更新与人工参数灵活配置，告别硬编码维护
- 将微服务内部调用认证参数 `AuthenticationDTO` 的签名算法从 **MD5** 升级为更安全的 **HMAC-SHA256**
- 角色设置武器开放 1-3 星武器的选择
- 声骸评分系统 VIP 价格由 39.99 改为 0.01
- 修复支付成功后有时邮件不发送的 Bug

**2025-12-23：[1.8.2]**

- 修复角色权重数据刷新后，声骸评分未更新的问题
- 修复角色设置武器界面的排序问题
- 修复批量添加声骸的漂泊者名称处理问题
- 新增用户最后一次访问时间记录
- 配置角色头像高清数据
- 项目文档新增《Nacos 配置文件.md》
