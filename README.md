...
![声骸评分系统 项目文档-1.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-1.png?v=2)
...
![声骸评分系统 项目文档-2.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-2.png?v=2)
...
![声骸评分系统 项目文档-3.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-3.png?v=2)

![声骸评分系统 项目文档-4.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-4.png?v=2)
...
![声骸评分系统 项目文档-5.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-5.png?v=2)

![声骸评分系统 项目文档-6.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-6.png?v=2)
...
![声骸评分系统 项目文档-7.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-7.png?v=2)

#### 3. 忘记密码

点击前往**忘记密码**模块![声骸评分系统 项目文档-8.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-8.png?v=2)

首先需要**进行电子邮件的验证**，依然是通过验证码的形式![声骸评分系统 项目文档-9.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-9.png?v=2)

之后**填写新密码**即可

![声骸评分系统 项目文档-10.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-10.png?v=2)
...
![声骸评分系统 项目文档-11.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-11.png?v=2)
...
![声骸评分系统 项目文档-12.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-12.png?v=2)

#### 6. 修改用户信息

**点击修改用户信息**，会出现表单模块

![声骸评分系统 项目文档-13.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-13.png?v=2)
...
![声骸评分系统 项目文档-14.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-14.png?v=2)

### ➤ 各模块特殊说明

#### 1. 筛选条件

![声骸评分系统 项目文档-15.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-15.png?v=2)
...
![声骸评分系统 项目文档-16.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-16.png?v=2)

![声骸评分系统 项目文档-17.jpg](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-17.jpg?v=2)

每个参数的含义如下：

![声骸评分系统 项目文档-18.jpg](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-18.jpg?v=2)

#### 3. 临时列表

鼠标放在声骸的得分单元格时，会出现**修改声骸 / 添加声骸**和**移除声骸**按钮

![声骸评分系统 项目文档-19.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-19.png?v=2)

![声骸评分系统 项目文档-20.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-20.png?v=2)

![声骸评分系统 项目文档-21.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-21.png?v=2)
...
![声骸评分系统 项目文档-22.jpg](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-22.jpg?v=2)

右侧表格的数据为：根据声骸列表中，该名角色的所有声骸的全部副词条属性的累加

##### 4.2 副词条平均加点次数

![声骸评分系统 项目文档-23.jpg](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-23.jpg?v=2)
...
![声骸评分系统 项目文档-24.jpg](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-24.jpg?v=2)
...
![声骸评分系统 项目文档-25.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-25.png?v=2)
...
![声骸评分系统 项目文档-26.jpg](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-26.jpg?v=2)
...
![声骸评分系统 项目文档-27.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-27.png?v=2)
...
![声骸评分系统 项目文档-28.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-28.png?v=2)
...
![声骸评分系统 项目文档-29.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-29.png?v=2)

点击即可设定该名角色的武器（不点击默认不进行更改）

关闭抽屉页面后设定生效

![声骸评分系统 项目文档-30.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-30.png?v=2)
...
![声骸评分系统 项目文档-31.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-31.png?v=2)

![声骸评分系统 项目文档-32.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-32.png?v=2)

使用支付宝沙箱版APP，扫这个二维码去付款，点击《我已完成支付》

![声骸评分系统 项目文档-33.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-33.png?v=2)

未支付响应：

![声骸评分系统 项目文档-34.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-34.png?v=2)

支付成功响应：

![声骸评分系统 项目文档-35.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-35.png?v=2)
...
![声骸评分系统 项目文档-36.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-36.png?v=2)

#### 9. 导入声骸数据

还是右上角头像处，**点击导入声骸数据**，会出现表单模块

![声骸评分系统 项目文档-37.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-37.png?v=2)

![声骸评分系统 项目文档-38.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-38.png?v=2)

相关参数的获取可以参考这个教程：[ProxyPin使用教程](http://8.138.214.176:5173/ProxyPin使用教程.html)

输入相关参数后，点击提交

![声骸评分系统 项目文档-39.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-39.png?v=2)

等待数据抓取，期间不要刷新页面

抓取成功后数据自动导入到声骸列表

![声骸评分系统 项目文档-40.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-40.png?v=2)
...
![声骸评分系统 项目文档-41.jpg](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-41.jpg?v=2)
...
![声骸评分系统 项目文档-42.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-42.png?v=2)
...
![声骸评分系统 项目文档-43.png](http://8.138.214.176:5173/项目图床/声骸评分系统%20项目文档-43.png?v=2)
